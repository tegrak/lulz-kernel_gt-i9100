...
#endif
#ifdef CONFIG_S5P_DEV_MSHC
	s3c_mshci_set_platdata(&smdkv310_mshc_pdata);
#endif
...
static void __init s5pv310_reserve(void)
{
	...
	static const char map[] __initconst =
		"android_pmem.0=pmem;android_pmem.1=pmem_gpu1;s3cfb.0=fimd;s3c-fimc.0=fimc0;s3c-fimc.1=fimc1;s3c-fimc.2=fimc2;s3c-fimc.3=fimc3;sc3-mfc=mfc,mfc0,mfc1;s5p-rp=srp;s5p-fimg2d=fimg2d";
	int i = 0;
	unsigned int bank0_end = meminfo.bank[0].start +g
					meminfo.bank[0].size;
